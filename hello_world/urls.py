...
from hello_world.core import views as core_views # Import the views from the core app
from pace_calculator.views import calculate_pace # Import the view from pace_calculator app
