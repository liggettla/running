...
def add_biometrics(request):
    ...
    def create_plot(attribute, title):
        ...
        p = figure(title=title, x_axis_label="Date", y_axis_label="Weight", x_axis_type="datetime", 
                   width=800, height=400, tools="pan,box_zoom,reset,save")
        p.circle(dates, weights, size=10, color="teal", alpha=0.25, legend_label="Weight")
